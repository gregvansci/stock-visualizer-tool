    ...
    <div className="flex flex-col items-center justify-center border-black">
      <div className="flex flex-col items-center min-w-full bg-primary bg-gradient-to-b from-primary to-secondary">
        <div className="top-0 z-50 max-w-3xl p-0 navbar">
          <div className="skew-x-3 navbar-start">
            <a className="px-2 text-2xl font-bold text-white skew-x-0 bg-black border-"><span className="text-palette-3">Stock</span>Check</a>
          </div>
          <div className="navbar-end">
            <button className="w-24 mr-3 text-black btn-xs btn glass btn-circle bg-palette-3">Log In</button>
